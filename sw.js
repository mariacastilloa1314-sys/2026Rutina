// Service Worker - Rutina Sagrada
const ALARMS = [
  {h:6,  m:0,  title:"🌅 ¡Buenos días!",           body:"Hora de despertar. Sin pantalla los primeros 10 min."},
  {h:6,  m:10, title:"💧 Agua y Skincare",           body:"Hidratación y rutina de mañana."},
  {h:6,  m:25, title:"🧘 Meditación — 20 min",       body:"Comienza ahora. Respira."},
  ...
  {h:14, m:35, title:"📚 Lectura — 1 hora",           body:"Apaga notificaciones."},
  {h:15, m:33, title:"⏱ Lectura termina en 2min",    body:"Prepárate para el ejercicio."},
  {h:17, m:0,  title:"💪 Ejercicio — 1 hora",         body:"¡Tú puedes!"},
  {h:17, m:58, title:"⏱ Ejercicio termina en 2min",  body:"Prepárate para la ducha."},
  {h:18, m:0,  title:"🚿 Ducha y recuperación",       body:"Recuperación post-entreno."},
...
self.addEventListener('message', event => {
  if (event.data && event.data.type === 'SCHEDULE') scheduleAll();
});
